...
export default function AboutPageClient({
  ...
  const [pageContent, setPageContent] = useState<AboutContent>(() => initialContent);
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-lg overflow-hidden w-full max-w-md ml-auto">
                <div
