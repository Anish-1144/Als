...
const FALLBACK_TEAM = [
  {
    ...
    title: "Mortgage Broker & Managing Director",
    initials: "AH",
  },
  {
    name: "John Martis",
...
export default async function ServicesPageClient({
  content,
}: {
  ...
  return (
    <div className="font-sans">
      <ServerPageHero
        slug="services"
        fallback={getPageHeroFallback("services", { height: "h-80" })}
        serifTitle={false}
      />
        ...
        <section className="py-20 px-6 md:px-12 lg:px-24">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              {servicesList.badge && <SectionBadge label={servicesList.badge} />}
              ...
              {servicesList.cards.map((service, index) => {
                ...
                return (
                  <Link key={index} href={service.link ?? "#"}>
                    <div className="group relative flex h-full flex-col p-8 rounded-2xl transition-all duration-300 cursor-pointer bg-[#1d293d] text-white hover:shadow-xl border border-gray-600 hover:border-[#00a69c]">
                      ...
                      <h3 className="text-2xl font-semibold mb-4 text-white group-hover:text-[#00a69c] transition-colors">
                        {service.title}
                      </h3>

                      <p className="leading-relaxed mb-6 text-gray-400 flex-1">
                        {service.description}
                      </p>
      ...
      {isSectionVisible(whyUs) && (
        <section className="py-20 px-6 md:px-12 lg:px-24 bg-[#2d3544]">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              {whyUs.badge && <SectionBadge label={whyUs.badge} />}
              <h2 className="text-4xl md:text-5xl font-medium text-white mb-8">
                {whyUs.title}
              </h2>
              {whyUs.subtitle && (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {whyUs.cards.map((card, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-[#1d293d] backdrop-blur-sm p-8 rounded-2xl border border-gray-600 text-center hover:border-[#00a69c] transition-colors"
                  >
      ...
      {isSectionVisible(teamSection) && (
        <section className="py-20 px-6 md:px-12 lg:px-24 bg-[#1d293d]">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              {teamSection.badge && <SectionBadge label={teamSection.badge} />}
              <h2 className="text-4xl md:text-5xl font-medium text-white mb-8">
                {teamSection.title}
              </h2>
              ...
              {sortedTeam.length > 0
                ? sortedTeam.slice(0, 3).map((member, index) => (
                    <div
                      ...
                      className="bg-[#2d3544] rounded-2xl shadow-xl overflow-hidden border border-gray-600"
                    >
                          ...
                          {member.phone && (
                            <div className="flex items-center gap-3">
                              ...
                              <a
                                ...
                                className="text-gray-300 hover:text-[#00a69c] text-sm"
                              >
                                {member.phone}
                              </a>
                            </div>
                          ...
                          {member.email && (
                            <div className="flex items-center gap-3">
                              ...
                              <a
                                ...
                                className="text-gray-300 hover:text-[#00a69c] text-sm break-all"
                              >
                                {member.email}
                              </a>
                            </div>
                ...
                : FALLBACK_TEAM.map((member) => (
                    <div
                      key={member.initials}
                      className="bg-[#2d3544] rounded-2xl p-8 shadow-lg text-center border border-gray-600"
                    >
            ...
            <div className="text-center mt-12">
              <Link
                href="/about"
                className="inline-flex items-center text-[#00a69c] font-semibold hover:text-white transition-colors"
              >
                View Full Team
