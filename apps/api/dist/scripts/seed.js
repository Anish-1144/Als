...
import { homepageSeedData, testimonialsSeedData, teamSeedData, footerSeedData, loanSeedData, faqSeedData, popupData, awardsData, lendersData, communityPostsData, documentsData, jobPostingsData, } from "../../../../lib/mock-data/index.js";
import { PAGE_REGISTRY } from "../../../../lib/page-registry.js";
import { DEFAULT_WHY_ALS_CONTENT, DEFAULT_ABOUT_CONTENT, DEFAULT_CAREERS_CONTENT, } from "../../../../lib/page-content.js";
import { DEFAULT_SERVICES_CONTENT, LOAN_PAGE_DEFAULTS, } from "../../../../lib/services-content.js";
import { DEFAULT_CALCULATORS_HUB_CONTENT, CALCULATOR_PAGE_DEFAULTS, } from "../../../../lib/calculator-content.js";
...
import { DEFAULT_DOCUMENTS_PAGE_CONTENT, DEFAULT_FAQ_PAGE_CONTENT, } from "../../../../lib/resources-content.js";
...
function pageSeedContent(slug) {
    ...
    if (slug in LOAN_PAGE_DEFAULTS) {
        return LOAN_PAGE_DEFAULTS[slug];
    }
    if (slug === "calculator")
        return DEFAULT_CALCULATORS_HUB_CONTENT;
    if (slug in CALCULATOR_PAGE_DEFAULTS) {
        return CALCULATOR_PAGE_DEFAULTS[slug];
    }
    if (slug === "how-it-works")
        return DEFAULT_HOW_IT_WORKS_CONTENT;
    if (slug in GUIDE_PAGE_DEFAULTS) {
        return GUIDE_PAGE_DEFAULTS[slug];
    }
    if (slug === "faq")
        return DEFAULT_FAQ_PAGE_CONTENT;
    if (slug === "documents")
        return DEFAULT_DOCUMENTS_PAGE_CONTENT;
    if (slug === "contact")
...
async function seed() {
    ...
    await Page.insertMany(PAGE_REGISTRY.map((p) => ({
        slug: p.slug,
        label: p.label,
        group: p.group,
        path: p.path,
