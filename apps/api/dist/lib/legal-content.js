...
exports.LEGAL_PAGE_DEFAULTS = exports.LEGAL_SLUGS = void 0;
exports.mergeLegalPageContent = mergeLegalPageContent;
exports.getLegalAdminPath = getLegalAdminPath;
exports.getLegalPublicPath = getLegalPublicPath;
exports.LEGAL_SLUGS = [
    "privacy-policy",
    "terms-of-service",
    "accessibility",
...
function mergeLegalPageContent(slug, raw) {
    const d = exports.LEGAL_PAGE_DEFAULTS[slug];
    return {
...
function getLegalAdminPath(slug) {
    return `/admin/legal/${slug}`;
}
function getLegalPublicPath(slug) {
    return `/legal/${slug}`;
}
