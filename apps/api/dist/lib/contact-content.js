...
exports.DEFAULT_CONTACT_CONTENT = void 0;
exports.mergeContactContent = mergeContactContent;
...
exports.DEFAULT_CONTACT_CONTENT = {
    infoSection: {
        title: "Get in Touch",
        phone: {
            title: "Phone",
...
function mergeContactContent(raw) {
    const d = exports.DEFAULT_CONTACT_CONTENT;
    return {
        infoSection: {
            ...d.infoSection,
            ...raw?.infoSection,
