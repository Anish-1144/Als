...
import {
  footerAdminRouter,
  navigationAdminRouter,
  popupAdminRouter,
} from "./routes/admin/singletons.js";
...
v1.use("/admin/users", adminUsersRoutes);
...
v1.use(
  "/admin/documents",
  createAdminCrudRouter(ResourceDocument, { order: 1 }),
);
v1.use(
  "/admin/careers/postings",
  createAdminCrudRouter(JobPosting, { order: 1 }),
);
v1.use("/admin/awards", createAdminCrudRouter(Award, { order: 1 }));
v1.use("/admin/lenders", createAdminCrudRouter(Lender, { order: 1 }));
v1.use(
  "/admin/community-posts",
  createAdminCrudRouter(CommunityPost, { order: 1 }),
);
