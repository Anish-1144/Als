  ...
  spotlightSections: [
    {
      ...
      subtitle:
        "Taking your first step onto the property ladder is an exciting milestone. We specialize in helping first home buyers navigate the complexities of purchasing their first property.",
      cardTitle: "First Home Buyer Benefits & Programs",
      cardBody:
        "As a first home buyer, you have access to various government grants, stamp duty concessions, and the First Home Guarantee scheme which allows you to purchase with as little as 5% deposit.",
      link: "/resources/first-home-buyer-guide",
    ...
    },
    {
      ...
      title: "Buying with a Guarantor",
      subtitle:
        "Get into the property market sooner with family support. A guarantor loan allows a family member to use their property as security.",
      cardTitle: "How Guarantor Loans Work",
      cardBody:
        "A guarantor uses the equity in their property as additional security for your home loan. This allows you to enter the property market with a smaller deposit or no deposit at all.",
