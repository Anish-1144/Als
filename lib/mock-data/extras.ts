...
export const awardsData: Array<{
...
}> = [
  {
    ...
    description:
      "Recognized for outstanding client service and ethical lending practices.",
    category: "industry",
    order: 1,
    featured: true,
    isActive: true,
...
export const jobPostingsData = [
  {
    ...
    type: "full-time",
    description:
      "Join our team as a Mortgage Broker and help Australian families achieve their property dreams.",
    responsibilities:
  ...
  },
  {
    ...
    type: "full-time",
    description:
      "Support our brokers by assessing loan applications and liaising with lenders.",
    responsibilities:
