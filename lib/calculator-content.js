...
export const DEFAULT_CALCULATORS_HUB_CONTENT = {
...
export const CALCULATOR_PAGE_DEFAULTS = {
    "borrowing-capacity": {
        pageHeader: {
...
export function mergeCalculatorsHubContent(raw) {
...
export function mergeCalculatorPageContent(slug, raw) {
...
export function getCalculatorAdminPath(slug) {
    if (slug === "calculator")
