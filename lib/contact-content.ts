...
function mergeLines(defaults: string[], raw?: string[]): string[] {
...
function mergeDetail(defaults: ContactDetail, raw?: Partial<ContactDetail>): ContactDetail {
  return { ...defaults, ...raw };
}
...
export const DEFAULT_CONTACT_CONTENT: ContactPageContent = {
  ...
  map: {
    title: "Find Us",
    embedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835434509374!2d144.9537353153169!3d-37.81627977975171!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d4c2b349649%3A0xb6899234e561db11!2sCollins%20St%2C%20Melbourne%20VIC%203000!5e0!3m2!1sen!2sau!4v1639000000000!5m2!1sen!2sau",
  },
  whyUs: {
    title: "Why Choose Us?",
    items: [
...
export function mergeContactContent(raw?: Partial<ContactPageContent>): ContactPageContent {
