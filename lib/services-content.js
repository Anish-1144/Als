...
export const LOAN_PAGE_DEFAULTS = {
...
export function mergeServicesContent(raw) {
...
export function mergeLoanPageContent(slug, raw) {
...
export function mergeServicePageContent(slug, raw) {
    if (slug === "services") {
        return mergeServicesContent(raw);
    }
    return mergeLoanPageContent(slug, raw);
}
export function getServiceAdminPath(slug) {
    if (slug === "services")
